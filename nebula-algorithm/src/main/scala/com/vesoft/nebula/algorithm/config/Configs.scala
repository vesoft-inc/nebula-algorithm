...
object AlgoConstants {
  ...
  val PAGERANK_RESULT_COL: String      = "_pagerank"
  val LOUVAIN_RESULT_COL: String       = "_louvain"
  val KCORE_RESULT_COL: String         = "_kcore"
  val LPA_RESULT_COL: String           = "_lpa"
  val CC_RESULT_COL: String            = "_cc"
  val SCC_RESULT_COL: String           = "_scc"
  val BETWEENNESS_RESULT_COL: String   = "_betweennedss"
  val SHORTPATH_RESULT_COL: String     = "_shortestpath"
  val DEGREE_RESULT_COL: String        = "_degree"
  val INDEGREE_RESULT_COL: String      = "_inDegree"
  val OUTDEGREE_RESULT_COL: String     = "_outDegree"
  val TRIANGLECOUNT_RESULT_COL: String = "_tranglecount"
}
